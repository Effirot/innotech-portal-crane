	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				ifLocalVar40_g92105 = Output_Converted717_g91921;
				...
				ifLocalVar40_g92106 = Output_Shader445_g91921;
				...
				ifLocalVar40_g92107 = Output_Scope1531_g91921;
				...
				ifLocalVar40_g92108 = Output_Lighting525_g91921;
				...
				ifLocalVar40_g92109 = Output_Custom1560_g91921;
				...
				ifLocalVar40_g92110 = Output_Sharing1355_g91921;
				float Debug_Index464_g91921 = TVE_DEBUG_Index;
				...
				ifLocalVar40_g92111 = Output_Maps561_g91921;
				...
				ifLocalVar40_g92112 = Output_Resolution737_g91921;
				...
				ifLocalVar40_g92113 = Output_MipLevel1284_g91921;
				...
				if( Debug_Index464_g91921 == 10.0 )
				ifLocalVar40_g92117 = appendResult1013_g91921;
				...
				float4 appendResult1659_g91921 = (float4(saturate( ( ( ( ifLocalVar40_g91931 + ( ifLocalVar40_g91946 + ifLocalVar40_g91956 ) + ( ifLocalVar40_g91939 + ifLocalVar40_g92011 + ifLocalVar40_g91940 + ifLocalVar40_g91933 ) + ( ifLocalVar40_g91929 + ifLocalVar40_g91943 + ifLocalVar40_g91998 ) + ( ifLocalVar40_g92117 + ifLocalVar40_g92091 + ifLocalVar40_g92092 ) ) - temp_cast_44 ) / ( temp_output_10_0_g92013 + 0.0001 ) ) ) , 1.0));
				float4 Output_Globals888_g91921 = appendResult1659_g91921;
				float4 ifLocalVar40_g92114 = 0;
				if( Debug_Type367_g91921 == 9.0 )
				ifLocalVar40_g92114 = Output_Globals888_g91921;
				float4 temp_output_35_0_g92097 = TVE_ColorsCoords;
				float temp_output_7_0_g92098 = 1.0;
				float2 temp_cast_45 = (temp_output_7_0_g92098).xx;
				float temp_output_10_0_g92098 = ( 1.0 - temp_output_7_0_g92098 );
				float2 temp_output_1583_0_g91921 = saturate( ( ( abs( (( (temp_output_35_0_g92097).zw + ( (temp_output_35_0_g92097).xy * (worldPos).xz ) )*2.0 + -1.0) ) - temp_cast_45 ) / temp_output_10_0_g92098 ) );
				float2 temp_output_1582_0_g91921 = ( temp_output_1583_0_g91921 * temp_output_1583_0_g91921 );
				float3 ifLocalVar40_g92118 = 0;
				if( Debug_Index464_g91921 == 0.0 )
				ifLocalVar40_g92118 = ( ( 1.0 - saturate( ( (temp_output_1582_0_g91921).x + (temp_output_1582_0_g91921).y ) ) ) * float3(0.5,0,0) );
				float4 temp_output_35_0_g92099 = TVE_ExtrasCoords;
				float temp_output_7_0_g92100 = 1.0;
				float2 temp_cast_46 = (temp_output_7_0_g92100).xx;
				float temp_output_10_0_g92100 = ( 1.0 - temp_output_7_0_g92100 );
				float2 temp_output_1602_0_g91921 = saturate( ( ( abs( (( (temp_output_35_0_g92099).zw + ( (temp_output_35_0_g92099).xy * (worldPos).xz ) )*2.0 + -1.0) ) - temp_cast_46 ) / temp_output_10_0_g92100 ) );
				float2 temp_output_1595_0_g91921 = ( temp_output_1602_0_g91921 * temp_output_1602_0_g91921 );
				float3 ifLocalVar40_g92119 = 0;
				if( Debug_Index464_g91921 == 1.0 )
				ifLocalVar40_g92119 = ( ( 1.0 - saturate( ( (temp_output_1595_0_g91921).x + (temp_output_1595_0_g91921).y ) ) ) * float3(0,0.5,0) );
				float4 temp_output_35_0_g92101 = TVE_MotionCoords;
				float temp_output_7_0_g92102 = 1.0;
				float2 temp_cast_47 = (temp_output_7_0_g92102).xx;
				float temp_output_10_0_g92102 = ( 1.0 - temp_output_7_0_g92102 );
				float2 temp_output_1615_0_g91921 = saturate( ( ( abs( (( (temp_output_35_0_g92101).zw + ( (temp_output_35_0_g92101).xy * (worldPos).xz ) )*2.0 + -1.0) ) - temp_cast_47 ) / temp_output_10_0_g92102 ) );
				float2 temp_output_1609_0_g91921 = ( temp_output_1615_0_g91921 * temp_output_1615_0_g91921 );
				float3 ifLocalVar40_g92120 = 0;
				if( Debug_Index464_g91921 == 2.0 )
				ifLocalVar40_g92120 = ( ( 1.0 - saturate( ( (temp_output_1609_0_g91921).x + (temp_output_1609_0_g91921).y ) ) ) * float3(0,0,1) );
				float4 temp_output_35_0_g92103 = TVE_VertexCoords;
				float temp_output_7_0_g92104 = 1.0;
				float2 temp_cast_48 = (temp_output_7_0_g92104).xx;
				float temp_output_10_0_g92104 = ( 1.0 - temp_output_7_0_g92104 );
				float2 temp_output_1628_0_g91921 = saturate( ( ( abs( (( (temp_output_35_0_g92103).zw + ( (temp_output_35_0_g92103).xy * (worldPos).xz ) )*2.0 + -1.0) ) - temp_cast_48 ) / temp_output_10_0_g92104 ) );
				float2 temp_output_1622_0_g91921 = ( temp_output_1628_0_g91921 * temp_output_1628_0_g91921 );
				float3 ifLocalVar40_g92121 = 0;
				if( Debug_Index464_g91921 == 3.0 )
				ifLocalVar40_g92121 = ( ( 1.0 - saturate( ( (temp_output_1622_0_g91921).x + (temp_output_1622_0_g91921).y ) ) ) * float3(0.5,0.5,0.5) );
				float4 appendResult1660_g91921 = (float4(saturate( ( ifLocalVar40_g92118 + ifLocalVar40_g92119 + ifLocalVar40_g92120 + ifLocalVar40_g92121 ) ) , 1.0));
				float4 Output_Volume1591_g91921 = appendResult1660_g91921;
				float4 ifLocalVar40_g92115 = 0;
				if( Debug_Type367_g91921 == 10.0 )
				ifLocalVar40_g92115 = Output_Volume1591_g91921;
				...
				float4 ifLocalVar40_g92116 = 0;
				if( Debug_Type367_g91921 == 11.0 )
				ifLocalVar40_g92116 = Output_Mesh316_g91921;
				...
				float4 lerpResult1517_g91921 = lerp( Shading_Inactive1492_g91921 , ( ( ifLocalVar40_g92105 + ifLocalVar40_g92106 + ifLocalVar40_g92107 + ifLocalVar40_g92108 + ifLocalVar40_g92109 + ifLocalVar40_g92110 ) + ( ifLocalVar40_g92111 + ifLocalVar40_g92112 + ifLocalVar40_g92113 ) + ( ifLocalVar40_g92114 + ifLocalVar40_g92115 + ifLocalVar40_g92116 ) ) , lerpResult1524_g91921);
...
ASEEND*/
//CHKSM=AE02C8CC0E15ABFF077DCF9F9D854565AF95716F
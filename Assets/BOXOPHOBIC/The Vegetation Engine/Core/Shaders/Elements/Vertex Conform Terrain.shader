	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half4 Colors37_g21548 = TVE_ColorsCoords;
				half4 Extras37_g21548 = TVE_ExtrasCoords;
				half4 Motion37_g21548 = TVE_MotionCoords;
				half4 Vertex37_g21548 = TVE_VertexCoords;
				half4 localIS_ELEMENT37_g21548 = IS_ELEMENT( Colors37_g21548 , Extras37_g21548 , Motion37_g21548 , Vertex37_g21548 );
				float4 temp_output_35_0_g21550 = localIS_ELEMENT37_g21548;
				float temp_output_7_0_g21551 = TVE_ElementsFadeValue;
				float2 temp_cast_0 = (temp_output_7_0_g21551).xx;
				float temp_output_10_0_g21551 = ( 1.0 - temp_output_7_0_g21551 );
				float2 temp_output_16_0_g21547 = saturate( ( ( abs( (( (temp_output_35_0_g21550).zw + ( (temp_output_35_0_g21550).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_0 ) / temp_output_10_0_g21551 ) );
				float2 temp_output_12_0_g21547 = ( temp_output_16_0_g21547 * temp_output_16_0_g21547 );
				float lerpResult18_g21547 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g21547).x + (temp_output_12_0_g21547).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha182 = ( _ElementIntensity * lerpResult18_g21547 );
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 temp_output_35_0_g21550 = localIS_ELEMENT37_g21548;
				float temp_output_7_0_g21551 = TVE_ElementsFadeValue;
				float2 temp_cast_2 = (temp_output_7_0_g21551).xx;
				float temp_output_10_0_g21551 = ( 1.0 - temp_output_7_0_g21551 );
				float2 temp_output_16_0_g21547 = saturate( ( ( abs( (( (temp_output_35_0_g21550).zw + ( (temp_output_35_0_g21550).xy * (WorldPosition).xz ) )*2.002 + -1.001) ) - temp_cast_2 ) / temp_output_10_0_g21551 ) );
				float2 temp_output_12_0_g21547 = ( temp_output_16_0_g21547 * temp_output_16_0_g21547 );
				float lerpResult18_g21547 = lerp( 1.0 , ( 1.0 - saturate( ( (temp_output_12_0_g21547).x + (temp_output_12_0_g21547).y ) ) ) , _ElementVolumeFadeMode);
				half Element_Alpha182 = ( _ElementIntensity * lerpResult18_g21547 );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;177;768,-512;Float;False;True;-1;2;TVEShaderElementGUI;100;21;BOXOPHOBIC/The Vegetation Engine/Elements/Vertex Conform (Terrain);f4f273c3bb6262d4396be458405e60f9;True;VolumePass;0;0;VolumePass;2;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=True=DisableBatching;False;False;0;True;True;2;5;False;;10;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;True;True;False;False;True;False;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;True;True;2;False;;True;0;False;;True;False;0;False;;0;False;;True;1;LightMode=VolumePass;True;2;False;0;;0;0;Standard;1;Vertex Position,InvertActionOnDeselection;1;0;0;2;True;True;False;;False;0
...
Node;AmplifyShaderEditor.FunctionNode;136;-2176,768;Inherit;False;Element Base Vertex;1;;21545;9f8670cd8fdc98444822270656343d82;0;0;1;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;174;-2176,832;Inherit;False;Element Fade Volume;17;;21547;4935729172cdadd45b9b14c3fa9c1db4;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=29CBD1004173F4A58EF7018E80D5C61186EAB6C1